<div class="form-group">
    ...
    @slot('uploadFields')
        {{ Form::file('contact', ['id' => 'contact_banner']) }}
    @endslot
    @endcomponent
</div>
<div class="form-group">
    <div class="row">
        <div class="col-sm-8">
            ...
            {{ Form::textarea('contact', $items->keyBy('key')['contact']['value']['description'] ?? null, ['class' => 'form-control', 'rows' => 3]) }}
        </div>
    </div>
</div>
...
<div class="form-group">
    <div class="row">
        <div class="col-sm-6">
            ...
            {{ Form::textarea('contact', $items->keyBy('key')['contact']['value']['custom_service'] ?? null, ['class' => 'form-control', 'rows' => 10]) }}
        </div>
        <div class="col-sm-6">
            ...
            @slot('uploadFields')
                {{ Form::file('contact', ['id' => 'contact_banner_1']) }}
            @endslot
            @endcomponent
        </div>
    </div>
...
<div class="form-group">
    <div class="row">
        <div class="col-sm-6">
            ...
            @slot('uploadFields')
                {{ Form::file('contact', ['id' => 'contact_banner_2']) }}
            @endslot
            @endcomponent
        </div>
        <div class="col-sm-6">
            {{ Form::label('description', 'Contact Information', ['class'=>'control-label']) }}
            {{ Form::textarea('contact', $items->keyBy('key')['contact']['value']['contact_information'] ?? null, ['class' => 'form-control', 'rows' => 10]) }}
        </div>
    </div>
</div>
